...
// Engineer: Group MPKP
// 
// Create Date: 11.11.2018 18:28:39
// Design Name: Tic Tac Toe
// Module Name: game
// Project Name: 
...
module position_decoder(input[3:0] in, input enable, output wire [15:0] out_en);
 ...
 always @(*)
  begin
    case(in)
      4'd1: temp1 <= 16'b0000000000000001;
      4'd2: temp1 <= 16'b0000000000000010; 
      4'd3: temp1 <= 16'b0000000000000100;
      4'd4: temp1 <= 16'b0000000000001000;
      4'd5: temp1 <= 16'b0000000000010000;
      4'd6: temp1 <= 16'b0000000000100000;
      4'd7: temp1 <= 16'b0000000001000000;
      4'd8: temp1 <= 16'b0000000010000000;
      4'd9: temp1 <= 16'b0000000100000000;
      ...
      4'd14: temp1 <= 16'b0010000000000000;
      4'd15: temp1 <= 16'b0100000000000000;
...
module playComp(input [1:0] pos1,pos2,pos3,pos4,pos5,pos6,pos7,pos8,pos9, output wire[15:0] PC_en);
    reg [15:0] temp;
